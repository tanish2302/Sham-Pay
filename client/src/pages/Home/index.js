...
function Home() {
    ...
    return (
        <div>
            <PageTitle
                title={`Hello ${user.firstName} ${user.lastName}, Welcome to Sham Pay`}
            />

            {/* Wrap the two cards in a flex container */}
            <div className="flex flex-col-mobile gap-2 mt-2">
                <div className="bg-tertiary p-2 br-3 flex flex-col gap-1 uppercase flex-1">
                ...
                <div className="card p-2 br-3 flex flex-col gap-1 uppercase flex-1">
                    <div className="flex justify-between">
